...
export default function CustomerForm({ setRowData }: CustomerFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    api
      ...
      .then((res) => {
        ...
        alert(`Uspesno unet zaposleni! ${res.data}`);
      })
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="text-gray-600">
              <FormControl>
                <Input placeholder={`Ime zaposlenog... `} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="text-gray-600">
              <FormControl>
                <Input placeholder={`Uloga zaposlenog... `} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
